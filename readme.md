# .NET Native AOT - where are we now, where are we heading?

This repo contains the slides and example code for Kenny Pflug's article on Native AOT in .NET 8. It is about to be published in the Windows Developer journal in September 2024.

All analysis results for the article can be found in the `Analysis` folder. 

## Prerequisites

You require the [.NET 8 SDK](https://dotnet.microsoft.com/en-us/download/dotnet/8.0) for the code examples. The code can run on multiple platforms and has been tested on Windows and Ubuntu. If you experience problems, please [create an issue](https://github.com/feO2x/dotnet-native-aot/issues/new) in this repo.
